    ...
    return (
        <section className={`scroll-section min-h-screen w-full flex items-center justify-center relative overflow-hidden py-24 md:py-0 transition-colors duration-1000 bg-transparent`}>
            ...
            <div className="text-center px-6 md:px-10 relative z-10">
                <h2 className={`animate-item text-6xl md:text-[12rem] font-serif tracking-tighter leading-none mb-10 md:mb-16 italic transition-colors duration-1000 ${isDarkMode ? 'text-white' : 'text-stone-900'}`}>
